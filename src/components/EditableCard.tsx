...
const EditableCard: React.FC<EditableCardProps> = ({ initialText = '', onTextChange, onReset, className = '' }) => {
  ...
  return (
    <div className="flex align-items-center justify-center">
      <div className={`${className} w-full bg-white shadow-xl rounded-2xl overflow-hidden`}>
        <div className="pt-8 pr-8 pl-8 relative">
          <textarea
            value={text}
            onChange={handleTextChange}
            className="w-full h-48 p-4 border border-gray-300 hover:border-gray-400 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200 overflow-auto"
            style={{ 
        ...
        <div className="px-8 py-4 space-y-4">
          ...
          <button
            ...
            className="w-full py-4 bg-black hover:bg-gray-800 text-white text-lg font-semibold rounded-xl focus:outline-none focus:shadow-outline"
          >
            Split Text
          </button>
